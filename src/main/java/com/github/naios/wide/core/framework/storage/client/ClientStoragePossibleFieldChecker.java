...
public enum ClientStoragePossibleFieldChecker
{
    STRING(String.class,
        (storage, column) ->
        {
    ...
    ClientStoragePossibleFieldChecker(final Class<?> type, final BiPredicate<ClientStorage<?>, Integer> check)
    {
        this.type = type;
        this.check = check;
    }
    ...
    public boolean check(final ClientStorage<?> storage, final Integer column)
    {
