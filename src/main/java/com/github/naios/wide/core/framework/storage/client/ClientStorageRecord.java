...
public class ClientStorageRecord
{
    ...
    public ClientStorageRecord(final ByteBuffer buffer,
            final ClientStorage<?> storage, final int offset)
    {
        this.buffer = buffer;
    ...
    {
        final ClientStorageFormer former = storage.getFormat().getFormerAtIndex(index);
