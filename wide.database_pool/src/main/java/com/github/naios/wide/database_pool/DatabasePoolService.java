...
public interface DatabasePoolService
{
     ...
     *
     * @return      Returns an {@link ObjectProperty} containing a {@link Database} object.
     *
     ...
     *
     * @return          Returns an {@link ObjectProperty} containing a {@link Database} object that on success.
     *
     * @throws          SQLException Throws {@link SQLException} that occur while trying to open a connection.
     */
